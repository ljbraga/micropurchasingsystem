...
/**
 * This class provides the representation of the details of a given
 * purchase.
 *
 * @author leonel.braga
 *
...
public class PurchaseDetails extends MetaModel{
	 ...
	 * 
	 * @param id the identifier of the purchasedetails, as it has to saved to
	 * the database
	 ...
	 */
	public PurchaseDetails(long id, String description, int quantity,
		double value
	) {
		super(id);
	 ...
	 * @param value
	 */
	public PurchaseDetails(String description, int quantity,
		double value
	) {
		super();
		this.description = description;
