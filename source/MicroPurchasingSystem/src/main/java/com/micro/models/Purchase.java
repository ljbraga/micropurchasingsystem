...
public class Purchase extends MetaModel {
    ...
    /**
     * the time in millis since the epoch that represents the expire time of the
     * purchase
     */
    ...
    /**
     * Creates a new purchase object. this constructor uses a details object
     * 
     * @param id
     ...
     *            the id of the purhcase details associated to this purhcase
     */
    public Purchase(long id, String productType, long expires, long purhcaseDetailsId) {
        super(id);
     ...
     */
    public Purchase(String productType, long expires, long purhcaseDetailsId) {
        super();
        this.productType = productType;
        this.expires = expires;
        this.purchaseDetailsId = purhcaseDetailsId;
    ...
    /**
     * sets new details for the purchase using a full PurchaseDetails object
     * 
     * @param details
     *            the details to set
     */
    ...
    /**
     * checks if the given purchase is valid. for a purchase to be valid it must
     * not have expired
     * 
