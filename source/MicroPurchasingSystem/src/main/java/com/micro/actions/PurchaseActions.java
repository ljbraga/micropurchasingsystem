...
public class PurchaseActions {
    ...
    /**
     * initialises the DAO objects taking into account the given dao
     * implementation
     * 
     * @param daoImplId
     * @throws InvalidDaoImplementation
     */
    public static void initDaoObjects(int daoImplId)
        throws InvalidDaoImplementation
    {
     ...
     * @param expires
     *            the expire time of the purchase in millis
     * @param description
    ...
    {
        PurchaseDetails details = PurchaseActions.createPurchaseDetails(description, quantity, value);
        Purchase purchase = new Purchase(productType, expires, details.getId());
        ...
        throws DatabaseError, ObjectNotFoundError
    {
        ...
        PurchaseDetails details = PurchaseActions.purchaseDetailsDao
    ...
    public static List<FullPurchase> getValidPurchases() throws DatabaseError {
        ...
        // in order to make the merge of the Purchase object with the
        // PurchaseDetails
        // object faster we will map the id of the PurchaseDetails to the
        // purchase
        // it belongs to
